...
# Параметры (можно оставить ваши или настроить под конкретный запуск)
β = 0.4
γ = 0.1
tmax = 50.0
...
# 2. Создаем анимацию
# Мы итерируемся по строкам DataFrame (каждый шаг времени — новый кадр)
